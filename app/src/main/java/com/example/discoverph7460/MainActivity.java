...
import com.example.discoverph7460.adapter.CityAdapter;
import com.example.discoverph7460.adapter.ProvinceAdapter;
...
public class MainActivity extends AppCompatActivity {
    //Declare the Navigation button variable
    BottomNavigationView homeNavigation;



    //Declare all recyclerview and adapters
    RecyclerView provinceRecycler, cityRecycler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Assign variables for Tab
        homeNavigation = findViewById(R.id.homeTab);
        //Set Home View
        homeNavigation.setSelectedItemId(R.id.homeScreen);
